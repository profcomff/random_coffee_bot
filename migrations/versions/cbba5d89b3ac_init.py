...
def upgrade():
    ...
    sa.ForeignKeyConstraint(['about_whom_id'], ['user_info.id'], ),
    sa.ForeignKeyConstraint(['met_id'], ['met_info.id'], ),
    sa.ForeignKeyConstraint(['who_id'], ['user_info.id'], ),
    sa.PrimaryKeyConstraint('id')
    )
